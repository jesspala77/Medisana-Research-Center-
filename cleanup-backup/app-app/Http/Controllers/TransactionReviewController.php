...
class TransactionReviewController extends Controller
{
    ...
    public function approve(
        ...
        $data = $request->validate([
            ...
            'construction_project_id' => ['nullable', 'integer'],
        ...
        TransactionClassificationFeedback::create([
            ...
            'previous_category' => $before['suggested_category'],
            'corrected_category' => $data['category'],
            'previous_project_id' => $before['construction_project_id'],
            'corrected_project_id' => $data['construction_project_id'] ?? null,
            'reviewer_id' => optional($request->user())->id,
