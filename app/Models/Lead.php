...
class Lead extends Model
{
    ...
    protected $casts = [
        ...
        'projected_monthly_revenue' => 'decimal:2',
    ...
    public function cncQuoteProfile()
    {
        return $this->hasOne(CncQuoteProfile::class);
    }

    public function aiOutreachMessages()
    {
        return $this->hasMany(AiOutreachMessage::class);
    }

    public function getProjectedYearlyRevenueAttribute()
    {
        return ($this->projected_monthly_revenue ?? 0) * 12;
    }

    public function isPalmettoProspect()
    {
        return in_array($this->palmetto_interest_level, ['High', 'Very High']);
    }
}
